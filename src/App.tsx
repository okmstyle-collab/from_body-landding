    ...
    <div className="flex flex-col w-full min-h-screen">
      ...
      <section id="programs" className="section-padding bg-gray-50">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid grid-rows-1 grid-flow-col auto-cols-[85%] sm:auto-cols-[60%] md:grid-rows-none md:grid-flow-row md:grid-cols-3 md:auto-cols-auto gap-6 md:gap-8 overflow-x-auto snap-x snap-mandatory pb-8 pt-4 md:pb-0 md:pt-0 [&::-webkit-scrollbar]:hidden [-ms-overflow-style:'none'] [scrollbar-width:'none']">
            {/* Health */}
            <motion.div {...fadeIn} className="snap-center flex-shrink-0 bg-white p-10 ring-4 ring-brand-point relative flex flex-col items-center text-center -translate-y-4 shadow-2xl">
            ...
            <motion.div 
              {...fadeIn} 
              className="snap-center flex-shrink-0 bg-white p-10 ring-4 ring-brand-point relative flex flex-col items-center text-center -translate-y-4 shadow-2xl"
            >
              <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-brand-point text-white text-xs font-black px-4 py-1 uppercase tracking-widest">Best Choice</div>
              <div className="flex items-center justify-center p-4 rounded-full bg-brand-point/10 mb-6">
